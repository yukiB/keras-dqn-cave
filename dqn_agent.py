...
class DQNAgent:
    ...
    def init_model(self):
        ...
        self.model.add(Convolution2D(32, 8, 8, border_mode='same', activation='relu', subsample=(4, 4)))
        self.model.add(Convolution2D(64, 4, 4, border_mode='same', activation='relu', subsample=(2, 2)))
        self.model.add(Convolution2D(64, 4, 4, border_mode='same', activation='relu', subsample=(2, 2)))
